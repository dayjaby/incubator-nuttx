...
#define LITEX_CPUTIMER_BASE CSR_CPU_BASE    /* riscv clint timer */
#define LITEX_TIMER0_BASE   CSR_TIMER0_BASE /* 0xf0002800 - : TIMER0 */
#define LITEX_UART0_BASE    CSR_UART_BASE   /* 0xf0002000 - : UART0 */
